...
#   distinct() |>
#   filter(license_year %in% c(2021,2022,2023)) |>
#   arrange(license_year, license_type) |>
#   group_by(license_year) |>
#   summarise(n_license = n())
  
  
write_rds(species_portfolio, here("Data", "species_level_portfolio.rds")) ## needed for fig_development.qmd
```
...
species_portfolio %>% 
  pivot_longer(cols = 3:20, names_to = "species", values_to = "count") %>%
...
write_rds(time_series, here("Data","species_time_series.rds")) # needed for fig_development.qmd
...
write_rds(annual_metrics, here("Data", "species_metrics_series.rds") # needed for fig_development.qmd
