...
# write_rds(species_portfolio, "stoll_portfolio.rds")
```
...
# write_rds(license_time_series, "stoll_time_series.rds")
...
write_rds(annual_metrics, file = "stoll_metrics_series.rds")
