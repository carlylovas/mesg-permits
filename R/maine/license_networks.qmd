...
# write_rds(clean_portfolio, here("Data", "clean_portfolio.rds")) ## needed for fig_development.qmd
```
...
ind_lic_portfolio %>%
  ...
  pivot_longer(cols = 3:51, names_to = "license_type", values_to = "count") %>%
  filter(!count == 0) %>%
...
# write_rds(license_time_series, here("Data","license_time_series.rds") # needed for fig_development.qmd
...
# write_rds(annual_metrics, here("Data","license_metrics_series.rds") # needed for fig_development.qmd
