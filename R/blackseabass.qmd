...
## Recent changes 
The Gulf of Maine has experienced unprecedented levels of ocean warming in the past decade. In order to examine these more recent changes, we're going to zoom in on 2010 onwards to see if there are any immediate patterns that jump out. 
