...
```
Available licenses types change over time as new opportunities and management practices take shape and fisheries expand or close. Below is a time series depicting the amount of unique license types available in a given year.
```{r}
