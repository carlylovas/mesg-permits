...
wrap_plots(license_time_series$time_series[c(1:15)], ncol = 3, nrow = 5)
...
#patchwork::wrap_plots(metrics_series$time_series[c(1:74)], ncol = 5, nrow = 15, heights = 3000, widths = 1000)
```
