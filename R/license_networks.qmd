...
gridExtra::marrangeGrob(license_time_series$time_series, layout_matrix = matrix(1:12, ncol = 3, nrow = 4), top = NULL)
...
gridExtra::marrangeGrob(metrics_series$time_series, layout_matrix = matrix(1:12, ncol = 3, nrow = 4), top = NULL)
```
