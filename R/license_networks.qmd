...
ind_lic_portfolio %>% 
  ...
  group_by(license_year, description) %>%
...
gridExtra::marrangeGrob(metrics_series$time_series, layout_matrix = matrix(1:15, ncol = 3, nrow = 5), top = NULL)
```
